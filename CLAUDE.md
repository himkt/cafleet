...
- **Design document**: `design-docs/0000010-sqlite-store-migration/design-doc.md` — SQLite + SQLAlchemy + Alembic store migration; in-process Pub/Sub fan-out (Status: Complete)
