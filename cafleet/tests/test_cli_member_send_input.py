...
class TestFlagValidation:
    ...
    def test_bash_flag_removed_no_such_option(
        self, runner, session_id, happy_path_agent
    ):
        """Regression guard: ``--bash`` was removed in design 0000037 and
        Click rejects the old form via its default ``No such option`` error.
        """
