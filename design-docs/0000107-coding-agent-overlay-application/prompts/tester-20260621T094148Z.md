...
- Coordinate via the verb + pointer schema (single-line poke) and COMMENT(tester) markers in the design doc — never free-form payload bodies.
...
IMPORTANT: This project uses mise full-path tasks. Run tests with mise //cafleet:test. Never bypass mise with the underlying tool.
