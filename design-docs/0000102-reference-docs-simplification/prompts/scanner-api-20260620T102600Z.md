...
CODING AGENT: claude
YOUR NAME: scanner-api
YOUR SLICE: the API-reference landing surface. Read these files in full:
  - docs/api/broker.md
  - docs/api/coding-agent.md
  - docs/api/config.md
  - docs/api/multiplexer.md
  - docs/index.md
YOUR FINDINGS FILE: /home/himkt/work/himkt/cafleet/design-docs/0000102-reference-docs-simplification/scan/findings-api.md
