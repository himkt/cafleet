...
DESIGN DOCUMENT: /home/himkt/work/himkt/cafleet/design-docs/0000061-purge-design-doc-refs-from-source/design-doc.md

TEAM COMPOSITION: This is a Programmer-only team (no Tester, no Verifier). The work is text-only cleanup — stripping design-doc citations from source comments, docstrings, and prose. There are no behavior changes and no new tests. Existing project tests run by `mise //cafleet:test` verify nothing regressed.
