...
**Status**: Approved
**Progress**: 59/61 tasks complete (Step 9 manual smoke deferred to user; final commit pending at finalization)
...
- [ ] Commit: `docs: record design 0000041 completion`. <!-- pending: deliberately unchecked. The Director runs this commit at finalization (design-doc-execute Step 8) after the Copilot review loop exits. The Progress header reads "59/61 (Step 9 manual smoke deferred to user; final commit pending at finalization)" to keep header and checklist consistent. -->
