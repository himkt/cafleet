...
BASE: /home/himkt/work/himkt/cafleet/design-docs/0000084-src-package-reorganization
DESIGN DOCUMENT: /home/himkt/work/himkt/cafleet/design-docs/0000084-src-package-reorganization/design-doc.md
...
IMPORTANT: As your very first Bash call, send the ready signal: cafleet --fleet-id {fleet_id} message send --agent-id {agent_id} --to {director_agent_id} --text "ready"
