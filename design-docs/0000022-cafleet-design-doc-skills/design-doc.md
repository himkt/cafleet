...
- [x] Create `.claude/skills/cafleet-design-doc-execute/SKILL.md` with full process (Steps 1–6), spawn prompts, TDD cycle, and role table <!-- completed: 2026-04-14T01:25 -->
