...
- the `cafleet-design-doc` skill — for the design-document format and the verb + pointer coordination protocol

FLEET ID: {fleet_id}
DIRECTOR AGENT ID: {director_agent_id}
YOUR AGENT ID: {agent_id}
BASE: /home/himkt/work/himkt/cafleet/design-docs/0000095-monitor-scope-and-execute-persistence
DESIGN DOCUMENT: /home/himkt/work/himkt/cafleet/design-docs/0000095-monitor-scope-and-execute-persistence/design-doc.md
