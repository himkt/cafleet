...
| `cafleet/src/cafleet/output.py` | `format_json`: drop the `*, pretty: bool = False` parameter and the `if pretty:` branch; keep only `json.dumps(data, separators=(",", ":"), ensure_ascii=False)`; remove the `pretty` mention from the docstring. |
