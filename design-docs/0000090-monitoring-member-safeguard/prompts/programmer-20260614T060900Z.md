...
DESIGN DOCUMENT: design-docs/0000090-monitoring-member-safeguard/design-doc.md
...
IMPORTANT: Use mise full-path tasks for lint/format/typecheck/test (see .claude/rules/commands.md). Do NOT bypass mise with the underlying tool.
