...
- [ ] should_ping + monitor_tick (heartbeat, liveness, due-set, single wake, gated ledger writes) + foreground loop with signal handling and ownership-checked cleanup <!-- completed: -->
