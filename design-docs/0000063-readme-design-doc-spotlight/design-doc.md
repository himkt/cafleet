...
- [x] The only source/documentation file changed by this branch is `README.md`; this design doc itself is updated to track progress and record Director arbitrations. `ARCHITECTURE.md`, `docs/`, `skills/*/SKILL.md`, source code, and tests are out of scope.
...
- [x] Confirm `git status` shows only `README.md` and this design doc modified — no other files touched. <!-- completed: 2026-05-16T14:05 -->
