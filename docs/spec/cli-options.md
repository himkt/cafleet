...
| `message broadcast` | One-line summary (`broadcast id=<id8> recipients=<count>`); `recipient_ids` omitted; per-recipient envelopes elided. | Full broadcast summary including `recipient_ids[]` and per-recipient envelopes. |
