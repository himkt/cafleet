...
The default database is `~/.local/share/cafleet/cafleet_v2.db`. Override with `CAFLEET_DATABASE_URL` (use an absolute path — SQLAlchemy does not expand `~` in SQLite URLs).
