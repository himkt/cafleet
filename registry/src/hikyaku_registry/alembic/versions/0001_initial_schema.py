...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['api_keys.api_key_hash'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('agent_id')
    )
    with op.batch_alter_table('agents', schema=None) as batch_op:
        batch_op.create_index('idx_agents_tenant_status', ['tenant_id', 'status'], unique=False)
    ...
    sa.ForeignKeyConstraint(['context_id'], ['agents.agent_id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('task_id')
    )
    with op.batch_alter_table('tasks', schema=None) as batch_op:
        batch_op.create_index('idx_tasks_context_status_ts', ['context_id', 'status_timestamp'], unique=False)
        batch_op.create_index('idx_tasks_from_agent_status_ts', ['from_agent_id', 'status_timestamp'], unique=False)
